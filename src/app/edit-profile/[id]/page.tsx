...
export default function EditProfile() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    const updatedUser: UserInterface = {
      ...
      firstName:
        capitalizeFirstLetter(newFirstName.toLowerCase()) || user.firstName,
    ...
    try {
      ...
      if (response.ok) {
        ...
        setErrorMessage(
          "Erreur lors de la mise à jour du profil: " + errorData.error
        );
      }
    } catch (error) {
  ...
  return (
    <div className="w-screen min-h-screen bg-white text-dark-pink text-lg flex">
      ...
      >
        ...
        <div className="flex flex-col">
          <label htmlFor="pp" className="font-bold">
            Photo de profil
          </label>
          {fileURL && (
            <Image
