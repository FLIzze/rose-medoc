...
const CalendarHeader = () => {
  const [isCalendarModeVisible, setIsCalendarModeVisible] = useAtom(
    isCalendarModeVisibleAtom
  );
  ...
  const endMonth = capitalizeFirstLetter(
    endOfWeek.toLocaleDateString("fr-FR", { month: "long" })
  );
  const monthDisplay =
  ...
  return (
    <div className="flex ml-16 justify-between items-center">
      <div className="flex items-center">
        <div className="flex">
          <button className="mr-3" onClick={goToToday}>
            <Image
              src="/home.png"
              alt="home"
